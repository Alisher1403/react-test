      ...
      <div className="max-w-4xl">
        ...
        <dl className="mt-3 text-sm">
          ...
          <div className="flex flex-col gap-1 border-gray-200 py-3 sm:flex-row sm:justify-between sm:gap-4">
            <dt className="text-label-secondary">Availability</dt>
